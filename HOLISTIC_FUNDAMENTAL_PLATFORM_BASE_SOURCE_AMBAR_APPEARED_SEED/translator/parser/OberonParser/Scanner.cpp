...
void Scanner::Init() {
	...
	keywords.set(L"ON", 30);
	keywords.set(L"MODULE", 31);
	keywords.set(L"LOAD", 32);
	keywords.set(L"BEGIN", 33);
	keywords.set(L"END", 34);
	keywords.set(L"UNLOAD", 35);
	keywords.set(L"OF", 40);
	keywords.set(L"ARRAY", 41);
	keywords.set(L"RECORD", 42);
	keywords.set(L"POINTER", 43);
	keywords.set(L"TO", 44);
	keywords.set(L"NIL", 46);
	keywords.set(L"ELSIF", 53);
	keywords.set(L"THEN", 54);
	keywords.set(L"DO", 56);
	keywords.set(L"IF", 57);
	keywords.set(L"ELSE", 58);
	keywords.set(L"CASE", 59);
	keywords.set(L"WHILE", 60);
	keywords.set(L"REPEAT", 61);
	keywords.set(L"UNTIL", 62);
	keywords.set(L"FOR", 63);
	keywords.set(L"BY", 64);
	keywords.set(L"LOOP", 65);
	keywords.set(L"WITH", 66);
	keywords.set(L"EXIT", 67);
	keywords.set(L"RETURN", 68);
